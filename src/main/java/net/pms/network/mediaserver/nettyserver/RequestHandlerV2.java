...
public class RequestHandlerV2 extends SimpleChannelUpstreamHandler {
	...
	public void messageReceived(ChannelHandlerContext ctx, MessageEvent event) throws Exception {
		...
		/**
		 * LG TVs send us many "play" requests while browsing directories, in
		 * order for them to show dynamic thumbnails. That means we can skip
		 * certain things like searching for subtitles and fully played logic.
		 */
